<template>
  <div class="p-20 flex flex-col gap-10 items-center">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-5 max-w-[840px]">
      <NuxtLink
      ...
      >
        <img
          ...
          class="w-40 h-40 rounded-xl smooth group-hover:scale-110"
        />
...
.card {
  @apply flex flex-col items-center gap-4 text-center py-8 px-4 rounded-[40px];
