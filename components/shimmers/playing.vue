<template>
  <div class="flex items-center flex-col gap-8">
    <div class="container">
      <div class="disc spin paused animate-pulse">
    ...
    <div class="w-full relative">
      ...
      <div class="knob" id="knob" :style="{ marginLeft: `${0}%` }"></div>
    </div>

    <div class="controls pointer-events-none opacity-55">
...
defineProps<{ deviceReady: boolean }>();
</script>
